...
class KalmanFilter(nn.Module):
    ...
    ## TODO: See if we want to do anythign with smooth
    # def smooth(self, X):
    ...
    #         )
    #
    #         ## TODO: See if we want to do anythign with smoothed kalman
    #         # (
    ...
    #         #
    #
    #         ## TODO: See if we want to do anythign with EM
    #         # (
    #         #     self.transition_matrices,
    #         #     self.observation_matrices,
    #         #     self.transition_offsets,
...
## Expectation Maximization Stuff will be taken care of later.
## WHen we dont have to worry too much aboutit.
# def _em(
#     observations,
#     transition_offsets,
#     observation_offsets,
